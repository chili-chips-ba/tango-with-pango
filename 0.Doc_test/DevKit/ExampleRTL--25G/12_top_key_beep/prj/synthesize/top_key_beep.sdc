###==== BEGIN "create_clock"
create_clock -name {top_key_beep|sys_clk} [get_ports {sys_clk}] -period {20.000} -waveform {0 10}
###==== END "create_clock"
...
set_clock_groups -name Inferred_clock_group_0 -asynchronous -group [get_clocks {top_key_beep|sys_clk}]
###==== END "set_clock_groups"

###==== BEGIN "set_external_delay"
###==== END "set_external_delay"
...
###==== BEGIN "set_disable_timing"
###==== END "set_disable_timing"
